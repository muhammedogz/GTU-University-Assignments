...
public class Test {
        ...
        while (true) {
            ...
            switch (choice) {
                case 1:
                    ...
                    break;
                case 2:
                    if (company.addAdmin(new CompanyAdministrator(company, getStr("Name:"), getStr("Surname:"),
                            getStr("Password:"))))
            ...
            try {
                switch (choice) {
                    case 0:
                        ...
                        break;
                    case 1:
                        ((CompanyAdministrator) admin).addBranch(new CompanyBranch(getInt("Branch Id:")));
                    ...
                    case 2:
                        ((CompanyAdministrator) admin)
                                .addBranchEmployee(new CompanyEmployee(company, getStr("Name:"), getStr("Surname:"),
                                        getStr("Password:"), company.getBranches().getItem(new CompanyBranch(getInt("Branch Id:")))));
    ...
    public static void quickCheckAllFunctions(){
        ...
        CompanyAdministrator admin = new CompanyAdministrator(company, "Admin", "123", "123");
        company.addAdmin(admin);
        System.out.println("Add new branch to company with id 10");
        CompanyBranch branch = new CompanyBranch(10);
        admin.addBranch(branch);
        System.out.println("Add new employee");
        System.out.println("Employee: Employee 123");
        CompanyEmployee employee = new CompanyEmployee(company, "Employee", "123", "123", branch);
